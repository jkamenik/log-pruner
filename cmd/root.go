...
var rootCmd = &cobra.Command{
	Use:   "log-pruner",
	Short: "A simple go server that monitors a directory and prunes files based on criteria.",
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".log-pruner-1" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".log-pruner-1")
	}
